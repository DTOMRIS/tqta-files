  ...
  return (
    <div className="p-6 space-y-6 bg-slate-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="border-t-4 border-t-purple-600 h-fit">
            <CardHeader>
                <CardTitle className="text-lg flex items-center gap-2">
                    <User className="text-purple-600"/> Tələbə Statusu
                </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
                <div className="p-3 bg-orange-50 border border-orange-200 rounded text-sm text-orange-800 flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs mt-1">Dərs: {new Date(student?.enrollmentDate).toLocaleDateString()}</p>
                    </div>
                </div>
        ...
        {/* SAĞ: EVIDENCE UPLOAD AREA (5 FOLDERS) */}
