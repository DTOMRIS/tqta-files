...
const slugMap = {
  ...
  'aşpaz-bacariqları': 'aspaz-bacariqlari', // URL encoded version
...
// Program verileri (gerçekte API'den gelecek)
const programs = {
  'aspaz-bacariqlari': {
...
export default function ProgramDetayPage({ params }) {
  ...
  // Slug mapping - hem encoded hem de decoded versiyonları kontrol et
